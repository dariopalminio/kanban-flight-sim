...
* **Status Category 'ToDo'**: Estados que representan trabajo pendiente o no iniciado. En nuestro diseño simple: L3 = "Backlog", L2 = "Backlog", L1 = "Backlog".
* **Status Category 'In-Progress'**: Estados que representan trabajo activo en proceso. En nuestro diseño simple: L3 = "En-Desarrollo", L2 = "Desarrollando-Release", L1 = "Desarrollo".
