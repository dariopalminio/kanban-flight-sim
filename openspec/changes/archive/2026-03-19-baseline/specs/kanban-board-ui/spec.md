...
The UI SHALL render four Kanban boards stacked vertically in hierarchical order: L3 at top, L2, L1, L0 at bottom. All four boards SHALL be visible simultaneously without horizontal scrolling.

#### Scenario: Boards rendered in L3→L0 order
- **WHEN** the application renders
- **THEN** the L3 board appears above L2, which appears above L1, which appears above L0
